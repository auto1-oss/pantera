...
/**
 * Tests for {@link PypiCooldownResponseFactory}.
 *
 * @since 2.2.0
 */
final class PypiCooldownResponseFactoryTest {

    private PypiCooldownResponseFactory factory;

    @BeforeEach
    void setUp() {
        this.factory = new PypiCooldownResponseFactory();
    }
    ...
    void bodyContainsBlockedMessage() {
        ...
        assertThat(body, containsString("Version blocked by cooldown policy. Blocked until:"));
    }
    ...
    @Test
    void repoTypeIsPypi() {
        assertThat(this.factory.repoType(), equalTo("pypi"));
    }
