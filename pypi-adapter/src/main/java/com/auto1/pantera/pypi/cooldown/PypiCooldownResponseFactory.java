...
/**
 * PyPI-specific cooldown 403 response factory.
 *
 ...
 * @since 2.2.0
 */
public final class PypiCooldownResponseFactory implements CooldownResponseFactory {
    ...
    public Response forbidden(final CooldownBlock block) {
        ...
        return ResponseBuilder.forbidden()
            ...
            .textBody("Version blocked by cooldown policy. Blocked until: " + until)
            .build();
    }
