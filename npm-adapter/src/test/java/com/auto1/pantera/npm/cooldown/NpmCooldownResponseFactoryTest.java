...
/**
 * Tests for {@link NpmCooldownResponseFactory}.
 *
 * @since 2.2.0
 */
final class NpmCooldownResponseFactoryTest {

    private NpmCooldownResponseFactory factory;

    @BeforeEach
    void setUp() {
        this.factory = new NpmCooldownResponseFactory();
    }
    ...
    @Test
    void repoTypeIsNpm() {
        assertThat(this.factory.repoType(), equalTo("npm"));
    }
