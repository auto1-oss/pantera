...
/**
 * NPM-specific cooldown 403 response factory.
 *
 * <p>Returns {@code application/json} body matching the npm error format.</p>
 *
 * @since 2.2.0
 */
public final class NpmCooldownResponseFactory implements CooldownResponseFactory {
