...
/**
 * Maven-specific cooldown 403 response factory.
 *
 * <p>Returns {@code text/plain} body with a human-readable blocked message
 * including the ISO-8601 unblock timestamp.</p>
 *
 * @since 2.2.0
 */
public final class MavenCooldownResponseFactory implements CooldownResponseFactory {
    ...
    public Response forbidden(final CooldownBlock block) {
        ...
        return ResponseBuilder.forbidden()
            ...
            .textBody("Artifact blocked by cooldown policy. Blocked until: " + until)
            .build();
    }
