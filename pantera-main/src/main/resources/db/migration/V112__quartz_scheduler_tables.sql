-- V112: Quartz JDBC scheduler tables
-- Standard Quartz 2.x schema for PostgreSQL. Order matters due to FKs.
-- Moved from QuartzSchema.java into Flyway for uniform deployment.
...
-- Performance indexes on QRTZ tables
