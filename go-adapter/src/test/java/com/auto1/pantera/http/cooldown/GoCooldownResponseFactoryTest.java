...
/**
 * Tests for {@link GoCooldownResponseFactory}.
 *
 * @since 2.2.0
 */
final class GoCooldownResponseFactoryTest {

    private GoCooldownResponseFactory factory;

    @BeforeEach
    void setUp() {
        this.factory = new GoCooldownResponseFactory();
    }
    ...
    void bodyContainsBlockedMessage() {
        ...
        assertThat(body, containsString("version blocked by cooldown policy until"));
    }
    ...
    @Test
    void repoTypeIsGo() {
        assertThat(this.factory.repoType(), equalTo("go"));
    }
