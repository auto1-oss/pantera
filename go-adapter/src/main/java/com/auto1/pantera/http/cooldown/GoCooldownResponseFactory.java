...
/**
 * Go-specific cooldown 403 response factory.
 *
 ...
 * @since 2.2.0
 */
public final class GoCooldownResponseFactory implements CooldownResponseFactory {
    ...
    public Response forbidden(final CooldownBlock block) {
        ...
        return ResponseBuilder.forbidden()
            ...
            .textBody("version blocked by cooldown policy until " + until)
            .build();
    }
